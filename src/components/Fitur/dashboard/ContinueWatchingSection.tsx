...
import { ambilKursusPengguna } from "@/services/layananKursus";
import { KursusPenggunaDatar } from "@/types";

export async function ContinueWatchingSection({ userId }: { userId?: string }) {
  let userCourses: KursusPenggunaDatar[] = [];

  if (userId && userId !== "undefined") {
    userCourses = await ambilKursusPengguna(userId);
  }
