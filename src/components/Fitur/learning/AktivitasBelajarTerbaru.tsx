...
import { Avatar } from "@/components/Bersama/ui/Avatar";
import { Clock } from "lucide-react";
import Image from "next/image";

export function AktivitasBelajarTerbaru({ activities = [] }: { activities?: { users?: { first_name?: string; avatar_url?: string }; is_completed?: boolean; module?: { title?: string; courses?: { category?: string } }; custom_text?: string; is_system?: boolean }[] }) {
