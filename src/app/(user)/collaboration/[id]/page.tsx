...
export default function ProjectDetailsPage() {
  ...
  const project = {
    ...
    team: [
      { name: "Alice W.", role: "UI/UX Designer", status: "ON TRACK", initials: "AW" },
      { name: "Bob K.", role: "Frontend Dev", status: "ON TRACK", initials: "BK" },
      { name: "Backend Developer", role: "Seeking", status: "Seeking", initials: "?" },
    ],
    milestones: [
      ...
      { title: "Due date 23", date: "View Prototypes", status: "PAST", type: "prototype", rightSide: true },
      { title: "Upcoming 21", date: "", status: "UPCOMING", type: "none", rightSide: true },
      { title: "MVP Launch", date: "Upcoming 13/26", status: "UPCOMING", type: "prototype", rightSide: true },
    ],
    workPackages: [
      { title: "User Flows", link: "Links: User Flows", status: "ACTIVE", assignee: "AW" },
      { title: "Homepage Component", link: "Links: Homepage", status: "DONE", assignee: "BK", assigneeName: "BOB" },
      { title: "User Auth API", link: "Links: User Auth API", status: "PENDING", assignee: "CD", assigneeName: "Charlie" },
    ],
    activities: [
      { user: "Alice", action: "updated User Flows", time: "" },
      { user: "Bob", action: "committed to Frontend repo", time: "" },
      { user: "Alice", action: "committed to Frontend repo", time: "" },
    ]
  };
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-black text-slate-800">
              Project Details: <span className="text-slate-400 font-medium ml-2"> &gt; {project.title}</span>
            </h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-3 flex flex-col gap-8">
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50">
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Project Type</span>
                  <span className="text-sm font-black text-slate-800 uppercase">{project.type}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Duration</span>
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50">
              <CardHeader 
                ...
                action={<span className="text-xs font-black text-slate-800 uppercase tracking-tighter">3/3 Roles Filled</span>}
              />
                    ...
                    <div key={i} className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-lg flex items-center justify-center text-[10px] font-black ${
                          member.status === "Seeking" ? "bg-slate-100 text-slate-400" : "bg-slate-200 text-slate-600"
                        }`}>
                          {member.initials}
                        </div>
                        <div>
                      ...
                      <span className={`px-2 py-1 rounded-md text-[9px] font-black uppercase ${
                        member.status === "ON TRACK" ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"
                      }`}>
                        {member.status}
                      </span>
                    </div>
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50">
              ...
              <div className="space-y-4 mt-2">
                ...
                <div className="flex items-center gap-3 text-slate-600 hover:text-primary transition-colors cursor-pointer group">
                  <Clock size={18} />
                  <div className="min-w-0">
                    <p className="text-xs font-black uppercase tracking-widest">Slack channel</p>
                ...
                <div className="space-y-24 relative">
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    <div className="w-1/2 pl-8">
                      ...
                      <div className="flex items-center gap-1 mt-1 text-[10px] text-slate-400 font-bold hover:text-primary cursor-pointer transition-colors">
                        <Layout size={10} /> View Prototypes
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-center justify-between">
                   ...
                   <div className="relative flex items-center justify-between">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full border-4 border-white bg-indigo-400 shadow-sm z-10"></div>
                    <div className="w-1/2 pl-8">
                      <h4 className="text-sm font-black text-slate-800 uppercase tracking-wide">MVP Launch</h4>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50">
              ...
              <div className="relative bg-slate-50 border border-slate-100 rounded-2xl h-40 flex items-center justify-center overflow-hidden mb-4 group cursor-pointer">
                <img 
                   src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=500&h=300&fit=crop&q=80" 
                   alt="Wireframe" 
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <p className="text-xs font-black text-slate-400 uppercase bg-white/80 px-4 py-2 rounded-xl border border-slate-100 shadow-sm backdrop-blur-sm group-hover:text-primary transition-colors">
                    FreshMart Wireframe Placeholder
                  </p>
                </div>
              </div>
            ...
            {/* Work Packages */}
            <Card className="border-none shadow-xl shadow-slate-200/50">
              <CardHeader title="Work Packages" />
