...
const menuItems = [
  ...
  { icon: Users, label: "Grup" }, // Sesuai dengan gambar
];
...
// ============================================================================
// 2. KOMPONEN LAYOUT & SIDEBAR (Bisa dipisah ke file layout.tsx nantinya)
// ============================================================================
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => (
  <aside
    className={`${isOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:static top-0 left-0 h-full w-64 bg-white border-r border-slate-100 flex flex-col transition-transform duration-300 z-40`}
  >
        ...
        <nav className="flex flex-col gap-1">
          {menuItems.map((item, index) => (
            <a
              key={index}
              href="#"
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors ${item.active ? "text-blue-600 bg-blue-50/50" : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"}`}
            >
              <item.icon
                size={20}
...
const DashboardLayout: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50/50 font-sans text-slate-900 overflow-hidden">
      ...
      {/* Komponen Sidebar dipanggil dengan state yang terintegrasi */}
...
// ============================================================================
// 3. KOMPONEN HALAMAN UTAMA (Bisa dipisah ke file page.tsx nantinya)
// ============================================================================
...
export default function Dashboard() {
  return (
    <DashboardLayout>
      ...
      {/* Banner Utama */}
      <section className="relative w-full rounded-[24px] bg-[#2563eb] overflow-hidden mb-8 p-8 md:px-12 md:py-10 text-white shadow-sm">
