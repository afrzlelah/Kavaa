...
import { Kontak, Pesan } from "./types";
...
export const menuItems = [
  ...
  { icon: ClipboardList, label: "Tugas", path: "/task" },
  { icon: Target, label: "Tantangan", path: "/challenge" },
  { icon: Users, label: "Collaboration", path: "/collaboration" },
  { icon: Award, label: "Reward & Sertifikat", path: "/reward-certificate" },
];
